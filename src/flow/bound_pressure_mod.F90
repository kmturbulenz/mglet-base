...
CONTAINS
    ...
    SUBROUTINE bound_pressure_impl_bp(ilevel, dp_f, bp_f, dx_f, dy_f, dz_f, &
        ...
        DO i = 1, nboundtasks
            ...
            CALL get_grid1x_real(dx, dx_f, igrid)
            CALL get_grid1y_real(dy, dy_f, igrid)
            CALL get_grid1z_real(dz, dz_f, igrid)
            CALL get_grid1x_real(ddx, ddx_f, igrid)
            CALL get_grid1y_real(ddy, ddy_f, igrid)
            CALL get_grid1z_real(ddz, ddz_f, igrid)
