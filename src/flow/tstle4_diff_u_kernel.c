...
#pragma omp for
        ...
        for (intk_c j = 3; j <= jj-2; ++j) {
            ...
            for (intk_c k = 3; k <= kk-2; ++k) {
                ...
                realk_c fvw = avx*(ut[idx3(kk, jj, k, j, i-1)] + ut[idx3(kk, jj, k, j+1, i-1)])*0.5;
                realk_c qkvwadd = 0.5*(fvw-abs_c(fvw)) *(0.5*v[idx3(kk, jj, k, j, i)]-1.5*v[idx3(kk, jj, k, j, i-1)]+v[idx3(kk, jj, k, j, i-2)])*0.5*0.5;
                vo[idx3(kk, jj, k, j, i)] = vo[idx3(kk, jj, k, j, i)] + fkdtv * rddzk * (-qkvwadd);
                vo[idx3(kk, jj, k, j, i-1)] = vo[idx3(kk, jj, k, j, i-1)] + fkdtv * rddzk * (+qkvwadd);
                realk_c fww = awx*(ut[idx3(kk, jj, k, j, i-1)]+ ut[idx3(kk, jj, k+1, j, i-1)])*0.5;
                realk_c qkwwadd = 0.5 *(fww-abs_c(fww)) *(0.5*w[idx3(kk, jj, k, j, i)]-1.5*w[idx3(kk, jj, k, j, i-1)]+w[idx3(kk, jj, k, j, i-2)])*0.5*0.5;
                wo[idx3(kk, jj, k, j, i)] = wo[idx3(kk, jj, k, j, i)] + fkdtw * rdzk * (-qkwwadd);
                wo[idx3(kk, jj, k, j, i-1)] = wo[idx3(kk, jj, k, j, i-1)] + fkdtw * rdzk * (+qkwwadd);
            }
        }
#if defined(_OPENMP)
#pragma omp barrier
...
#pragma omp for
        ...
        for (intk_c j = 3; j <= jj-2; ++j) {
            ...
            for (intk_c k = 3; k <= kk-2; ++k) {
                ...
                realk_c awx = ddyj*dzk;
                realk_c fvw = avx*(ut[idx3(kk, jj, k, j, i-1)] + ut[idx3(kk, jj, k, j+1, i-1)])*0.5;
                realk_c qkvwadd = 0.5*(fvw+abs_c(fvw)) *(0.5*v[idx3(kk, jj, k, j, i-1)]-1.5*v[idx3(kk, jj, k, j, i)]+v[idx3(kk, jj, k, j, i+1)])*0.5*0.5;
                vo[idx3(kk, jj, k, j, i)] = vo[idx3(kk, jj, k, j, i)] + fkdtv * rddzk * (-qkvwadd);
                vo[idx3(kk, jj, k, j, i-1)] = vo[idx3(kk, jj, k, j, i-1)] + fkdtv * rddzk * (+qkvwadd);
                realk_c fww = awx*(ut[idx3(kk, jj, k, j, i-1)]+ ut[idx3(kk, jj, k+1, j, i-1)])*0.5;
                realk_c qkwwadd = 0.5*(fww+abs_c(fww)) *(0.5*w[idx3(kk, jj, k, j, i-1)]-1.5*w[idx3(kk, jj, k, j, i)]+w[idx3(kk, jj, k, j, i+1)])*0.5*0.5;
                wo[idx3(kk, jj, k, j, i)] = wo[idx3(kk, jj, k, j, i)] + fkdtw * rdzk * (-qkwwadd);
                wo[idx3(kk, jj, k, j, i-1)] = wo[idx3(kk, jj, k, j, i-1)] + fkdtw * rdzk * (+qkwwadd);
            }
        }
...
#pragma omp for
        ...
        for (intk_c i = 3; i <= ii-2; ++i) {
            ...
            for (intk_c k = 3; k <= kk-2; ++k) {
                ...
                realk_c fus = auy*(vt[idx3(kk, jj, k, j-1, i)] + vt[idx3(kk, jj, k, j-1, i+1)])*0.5;
                realk_c qkusadd = 0.5 *(fus-abs_c(fus)) *(0.5*u[idx3(kk, jj, k, j, i)]-1.5*u[idx3(kk, jj, k, j-1, i)]+u[idx3(kk, jj, k, j-2, i)])*0.5*0.5;
                uo[idx3(kk, jj, k, j, i)] = uo[idx3(kk, jj, k, j, i)] + fkdtu * rddzk * (-qkusadd);
                uo[idx3(kk, jj, k, j-1, i)] = uo[idx3(kk, jj, k, j-1, i)] + fkdtu * rddzk * (+qkusadd);
                realk_c fws = awy*(vt[idx3(kk, jj, k, j-1, i)]+ vt[idx3(kk, jj, k+1, j-1, i)])*0.5;
                realk_c qkwsadd = 0.5 *(fws-abs_c(fws)) *(0.5*w[idx3(kk, jj, k, j, i)]-1.5*w[idx3(kk, jj, k, j-1, i)]+w[idx3(kk, jj, k, j-2, i)])*0.5*0.5;
                wo[idx3(kk, jj, k, j, i)] = wo[idx3(kk, jj, k, j, i)] + fkdtw * rdzk * (-qkwsadd);
                wo[idx3(kk, jj, k, j-1, i)] = wo[idx3(kk, jj, k, j-1, i)] + fkdtw * rdzk * (+qkwsadd);
            }
        }
#if defined(_OPENMP)
#pragma omp barrier
...
#pragma omp for
        ...
        for (intk_c i = 3; i <= ii-2; ++i) {
            ...
            for (intk_c k = 3; k <= kk-2; ++k) {
                ...
                realk_c awy = ddxi*dzk;
                realk_c fus = auy*(vt[idx3(kk, jj, k, j-1, i)] + vt[idx3(kk, jj, k, j-1, i+1)])*0.5;
                realk_c qkusadd = 0.5*(fus+abs_c(fus)) *(0.5*u[idx3(kk, jj, k, j-1, i)]-1.5*u[idx3(kk, jj, k, j, i)]+u[idx3(kk, jj, k, j+1, i)])*0.5*0.5;
                uo[idx3(kk, jj, k, j, i)] = uo[idx3(kk, jj, k, j, i)] + fkdtu * rddzk * (-qkusadd);
                uo[idx3(kk, jj, k, j-1, i)] = uo[idx3(kk, jj, k, j-1, i)] + fkdtu * rddzk * (+qkusadd);
                realk_c fws = awy*(vt[idx3(kk, jj, k, j-1, i)] + vt[idx3(kk, jj, k+1, j-1, i)])*0.5;
                realk_c qkwsadd = 0.5*(fws+abs_c(fws)) *(0.5*w[idx3(kk, jj, k, j-1, i)]-1.5*w[idx3(kk, jj, k, j, i)]+w[idx3(kk, jj, k, j+1, i)])*0.5*0.5;
                wo[idx3(kk, jj, k, j, i)] = wo[idx3(kk, jj, k, j, i)] + fkdtw * rdzk * (-qkwsadd);
                wo[idx3(kk, jj, k, j-1, i)] = wo[idx3(kk, jj, k, j-1, i)] + fkdtw * rdzk * (+qkwsadd);
            }
        }
...
#pragma omp for
        ...
        for (intk_c i = 3; i <= ii-2; ++i) {
            ...
            for (intk_c j = 3; j <= jj-2; ++j) {
                ...
                realk_c rdzk = rdz[idx1(k)];
                realk_c rddzk = rddz[idx1(k)];
                realk_c fub = auz*(wt[idx3(kk, jj, k-1, j, i)]+ wt[idx3(kk, jj, k-1, j, i+1)])*0.5;
                realk_c qkubadd = 0.5*(fub-abs_c(fub)) *(0.5*u[idx3(kk, jj, k, j, i)]-1.5*u[idx3(kk, jj, k-1, j, i)]+u[idx3(kk, jj, k-2, j, i)])*0.5*0.5;
                uo[idx3(kk, jj, k, j, i)] = uo[idx3(kk, jj, k, j, i)] + fkdtu * rddzk * (-qkubadd);
                uo[idx3(kk, jj, k-1, j, i)] = uo[idx3(kk, jj, k-1, j, i)] + fkdtu * rddzk * (+qkubadd);
                realk_c fvb = avz*(wt[idx3(kk, jj, k-1, j, i)] + wt[idx3(kk, jj, k-1, j+1, i)])*0.5;
                realk_c qkvbadd = 0.5*(fvb-abs_c(fvb)) *(0.5*v[idx3(kk, jj, k, j, i)]-1.5*v[idx3(kk, jj, k-1, j, i)]+v[idx3(kk, jj, k-2, j, i)])*0.5*0.5;
                vo[idx3(kk, jj, k, j, i)] = vo[idx3(kk, jj, k, j, i)] + fkdtv * rddzk * (-qkvbadd);
                vo[idx3(kk, jj, k-1, j, i)] = vo[idx3(kk, jj, k-1, j, i)] + fkdtv * rddzk * (+qkvbadd);
            }
        }
#if defined(_OPENMP)
#pragma omp barrier
...
#pragma omp for
        ...
        for (intk_c i = 3; i <= ii-2; ++i) {
            ...
            for (intk_c j = 3; j <= jj-2; ++j) {
                ...
                realk_c rddzk = rddz[idx1(k)];
                realk_c fub = auz*(wt[idx3(kk, jj, k-1, j, i)] + wt[idx3(kk, jj, k-1, j, i+1)])*0.5;
                realk_c qkubadd = 0.5 *(fub+abs_c(fub)) *(0.5*u[idx3(kk, jj, k-1, j, i)]-1.5*u[idx3(kk, jj, k, j, i)]+u[idx3(kk, jj, k+1, j, i)])*0.5*0.5;
                uo[idx3(kk, jj, k, j, i)] = uo[idx3(kk, jj, k, j, i)] + fkdtu * rddzk * (-qkubadd);
                uo[idx3(kk, jj, k-1, j, i)] = uo[idx3(kk, jj, k-1, j, i)] + fkdtu * rddzk * (+qkubadd);
                realk_c fvb = avz*(wt[idx3(kk, jj, k-1, j, i)]+ wt[idx3(kk, jj, k-1, j+1, i)])*0.5;
                realk_c qkvbadd = 0.5 *(fvb+abs_c(fvb)) *(0.5*v[idx3(kk, jj, k-1, j, i)]-1.5*v[idx3(kk, jj, k, j, i)]+v[idx3(kk, jj, k+1, j, i)])*0.5*0.5;
                vo[idx3(kk, jj, k, j, i)] = vo[idx3(kk, jj, k, j, i)] + fkdtv * rddzk * (-qkvbadd);
                vo[idx3(kk, jj, k-1, j, i)] = vo[idx3(kk, jj, k-1, j, i)] + fkdtv * rddzk * (+qkvbadd);
            }
        }
...
#pragma omp for
        ...
        for (intk_c j = 3; j <= jj-2; ++j) {
            ...
            for (intk_c k = 2; k <= kk-2; ++k) {
                realk_c dzk = dz[idx1(k)];
                realk_c awx = ddyj*dzk;
                realk_c fwe = awx*(ut[idx3(kk, jj, k, j, i)] + ut[idx3(kk, jj, k+1, j, i)])*0.5;
                realk_c qkwe = 0.5*fwe*(w[idx3(kk, jj, k, j, i)] + w[idx3(kk, jj, k, j, i+1)]);
...
#pragma omp for
        ...
        for (intk_c j = 3; j <= jj-2; j += 2) {
            ...
            realk_c dzk = dz[idx1(k)];
            realk_c awx = ddyj*dzk;
            realk_c fwe = awx*(2*ut[idx3(kk, jj, k, j, i)] + 2*ut[idx3(kk, jj, k, j+1, i)] + ut[idx3(kk, jj, k+1, j, i)] + ut[idx3(kk, jj, k+1, j+1, i)] + ut[idx3(kk, jj, k+2, j, i)] + ut[idx3(kk, jj, k+2, j+1, i)])*0.125;
            realk_c qkwe = 0.5*fwe*(w[idx3(kk, jj, k, j, i)] + w[idx3(kk, jj, k, j, i+1)]);
            wcw[idx3(kk, jj, k, j, i)] = qkwe;
            qkwe = 0.5*fwe*(w[idx3(kk, jj, k, j+1, i)] + w[idx3(kk, jj, k, j+1, i+1)]);
            wcw[idx3(kk, jj, k, j+1, i)] = qkwe;
            for (intk_c k = 4; k <= kk-4; k += 2) {
                dzk = dz[idx1(k)];
                awx = ddyj*dzk;
                fwe = awx*(ut[idx3(kk, jj, k-1, j, i)] + ut[idx3(kk, jj, k-1, j+1, i)] + ut[idx3(kk, jj, k, j, i)] + ut[idx3(kk, jj, k, j+1, i)] + ut[idx3(kk, jj, k+1, j, i)] + ut[idx3(kk, jj, k+1, j+1, i)] + ut[idx3(kk, jj, k+2, j, i)]+ ut[idx3(kk, jj, k+2, j+1, i)])*0.125;
                qkwe = 0.5*fwe*(w[idx3(kk, jj, k, j, i)] + w[idx3(kk, jj, k, j, i+1)]);
                wcw[idx3(kk, jj, k, j, i)] = qkwe;
                qkwe = 0.5*fwe*(w[idx3(kk, jj, k, j+1, i)] + w[idx3(kk, jj, k, j+1, i+1)]);
                wcw[idx3(kk, jj, k, j+1, i)] = qkwe;
            }
            ...
            dzk = dz[idx1(k)];
            awx = ddyj*dzk;
            fwe = awx*(ut[idx3(kk, jj, k-1, j, i)] + ut[idx3(kk, jj, k-1, j+1, i)] + ut[idx3(kk, jj, k, j, i)] + ut[idx3(kk, jj, k, j+1, i)] + 2*ut[idx3(kk, jj, k+1, j, i)] + 2*ut[idx3(kk, jj, k+1, j+1, i)]) *0.125;
            qkwe = 0.5*fwe*(w[idx3(kk, jj, k, j, i)] + w[idx3(kk, jj, k, j, i+1)]);
            wcw[idx3(kk, jj, k, j, i)] = qkwe;
            qkwe = 0.5*fwe*(w[idx3(kk, jj, k, j+1, i)] + w[idx3(kk, jj, k, j+1, i+1)]);
            wcw[idx3(kk, jj, k, j+1, i)] = qkwe;
...
#pragma omp for collapse(2)
        ...
        for (intk_c j = 3; j <= jj-2; ++j) {
            for (intk_c k = 2; k <= kk-4; k += 2) {
                wcw[idx3(kk, jj, k+1, j, i)] = 0.5*(wcw[idx3(kk, jj, k, j, i)] + wcw[idx3(kk, jj, k+2, j, i)]);
            }
        }
#if defined(_OPENMP)
#pragma omp barrier
...
#pragma omp for
        ...
        for (intk_c j = 3; j <= jj-2; ++j) {
            ...
            for (intk_c k = 2; k <= kk-2; ++k) {
                realk_c rdzk = rdz[idx1(k)];
                wo[idx3(kk, jj, k, j, i)] = wo[idx3(kk, jj, k, j, i)] + fkdtw*rdzk*(-wcw[idx3(kk, jj, k, j, i+1)] + wcw[idx3(kk, jj, k, j, i)]);
            }
        }
#if defined(_OPENMP)
#pragma omp barrier
...
#pragma omp for
        ...
        for (intk_c j = 2; j <= jj-2; ++j) {
            ...
            for (intk_c k = 3; k <= kk-2; ++k) {
                ...
                realk_c fve = avx *(ut[idx3(kk, jj, k, j, i)] + ut[idx3(kk, jj, k, j+1, i)])*0.5;
                realk_c qkve = 0.5*fve*(v[idx3(kk, jj, k, j, i)] + v[idx3(kk, jj, k, j, i+1)]);
...
#pragma omp for
        ...
        for (intk_c k = 3; k <= kk-2; k += 2) {
            realk_c ddzk = ddz[idx1(k)];
            realk_c avx = ddzk*dyj;
            realk_c fve = avx*(2*ut[idx3(kk, jj, k, j, i)] + 2*ut[idx3(kk, jj, k+1, j, i)] + ut[idx3(kk, jj, k, j+1, i)] + ut[idx3(kk, jj, k+1, j+1, i)] + ut[idx3(kk, jj, k, j+2, i)] + ut[idx3(kk, jj, k+1, j+2, i)])*0.125;
            realk_c qkve = 0.5*fve*(v[idx3(kk, jj, k, j, i)] + v[idx3(kk, jj, k, j, i+1)]);
            wcv[idx3(kk, jj, k, j, i)] = qkve;
            qkve = 0.5*fve*(v[idx3(kk, jj, k+1, j, i)] + v[idx3(kk, jj, k+1, j, i+1)]);
...
#pragma omp for
        ...
        for (intk_c j = 4; j <= jj-4; j += 2) {
            ...
            for (intk_c k = 3; k <= kk-2; k += 2) {
                realk_c ddzk = ddz[idx1(k)];
                realk_c avx = ddzk*dyj;
                realk_c fve = avx*(ut[idx3(kk, jj, k, j-1, i)] + ut[idx3(kk, jj, k+1, j-1, i)] + ut[idx3(kk, jj, k, j, i)] + ut[idx3(kk, jj, k+1, j, i)] + ut[idx3(kk, jj, k, j+1, i)] + ut[idx3(kk, jj, k+1, j+1, i)] + ut[idx3(kk, jj, k, j+2, i)] + ut[idx3(kk, jj, k+1, j+2, i)])*0.125;
                realk_c qkve = 0.5*fve*(v[idx3(kk, jj, k, j, i)] + v[idx3(kk, jj, k, j, i+1)]);
                wcv[idx3(kk, jj, k, j, i)] = qkve;
                qkve = 0.5*fve*(v[idx3(kk, jj, k+1, j, i)] + v[idx3(kk, jj, k+1, j, i+1)]);
                wcv[idx3(kk, jj, k+1, j, i)] = qkve;
...
#pragma omp for
        ...
        for (intk_c k = 3; k <= kk-2; k += 2) {
            realk_c ddzk = ddz[idx1(k)];
            realk_c avx = ddzk*dyj;
            realk_c fve = avx*(ut[idx3(kk, jj, k, j-1, i)] + ut[idx3(kk, jj, k+1, j-1, i)] + ut[idx3(kk, jj, k, j, i)] + ut[idx3(kk, jj, k+1, j, i)] + 2*ut[idx3(kk, jj, k, j+1, i)] + 2*ut[idx3(kk, jj, k+1, j+1, i)])*0.125;
            realk_c qkve = 0.5*fve*(v[idx3(kk, jj, k, j, i)] + v[idx3(kk, jj, k, j, i+1)]);
            wcv[idx3(kk, jj, k, j, i)] = qkve;
            qkve = 0.5*fve*(v[idx3(kk, jj, k+1, j, i)] + v[idx3(kk, jj, k+1, j, i+1)]);
            wcv[idx3(kk, jj, k+1, j, i)] = qkve;
...
#pragma omp for collapse(2)
        ...
        for (intk_c j = 2; j <= jj-4; j += 2) {
            for (intk_c k = 3; k <= kk-2; ++k) {
                wcv[idx3(kk, jj, k, j+1, i)] = 0.5*(wcv[idx3(kk, jj, k, j, i)] + wcv[idx3(kk, jj, k, j+2, i)]);
            }
        }
#if defined(_OPENMP)
#pragma omp barrier
...
#pragma omp for
        ...
        for (intk_c j = 2; j <= jj-2; ++j) {
            ...
            for (intk_c k = 3; k <= kk-2; ++k) {
                realk_c rddzk = rddz[idx1(k)];
                vo[idx3(kk, jj, k, j, i)] = vo[idx3(kk, jj, k, j, i)] + fkdtv*rddzk*(wcv[idx3(kk, jj, k, j, i)] - wcv[idx3(kk, jj, k, j, i+1)]);
            }
        }
#if defined(_OPENMP)
#pragma omp barrier
...
#pragma omp for
        ...
        for (intk_c j = 3; j <= jj-2; ++j) {
            ...
            for (intk_c k = 2; k <= kk-2; ++k) {
                ...
                realk_c awx = ddyj*dzk;
                realk_c fww = awx*(ut[idx3(kk, jj, k, j, i-1)] + ut[idx3(kk, jj, k+1, j, i-1)])*0.5;
                realk_c qkww = 0.5*fww*(w[idx3(kk, jj, k, j, i)] + w[idx3(kk, jj, k, j, i-1)]);
...
#pragma omp for
        ...
        for (intk_c j = 3; j <= jj-2; j += 2) {
            ...
            realk_c dzk = dz[idx1(k)];
            realk_c awx = ddyj*dzk;
            realk_c fww = awx*(2*ut[idx3(kk, jj, k, j, i-1)] + 2*ut[idx3(kk, jj, k, j+1, i-1)] + ut[idx3(kk, jj, k+1, j, i-1)] + ut[idx3(kk, jj, k+1, j+1, i-1)] + ut[idx3(kk, jj, k+2, j, i-1)] + ut[idx3(kk, jj, k+2, j+1, i-1)])*0.125;
            realk_c qkww = 0.5*fww*(w[idx3(kk, jj, k, j, i)] + w[idx3(kk, jj, k, j, i-1)]);
            wcw[idx3(kk, jj, k, j, i)] = qkww;
            qkww = 0.5*fww*(w[idx3(kk, jj, k, j+1, i)] + w[idx3(kk, jj, k, j+1, i-1)]);
            wcw[idx3(kk, jj, k, j+1, i)] = qkww;
            for (intk_c k = 4; k <= kk-4; k += 2) {
                dzk = dz[idx1(k)];
                awx = ddyj*dzk;
                fww = awx*(ut[idx3(kk, jj, k-1, j, i-1)] + ut[idx3(kk, jj, k-1, j+1, i-1)] + ut[idx3(kk, jj, k, j, i-1)] + ut[idx3(kk, jj, k, j+1, i-1)] + ut[idx3(kk, jj, k+1, j, i-1)] + ut[idx3(kk, jj, k+1, j+1, i-1)] + ut[idx3(kk, jj, k+2, j, i-1)] + ut[idx3(kk, jj, k+2, j+1, i-1)])*0.125;
                qkww = 0.5*fww*(w[idx3(kk, jj, k, j, i)] + w[idx3(kk, jj, k, j, i-1)]);
                wcw[idx3(kk, jj, k, j, i)] = qkww;
                qkww = 0.5*fww*(w[idx3(kk, jj, k, j+1, i)] + w[idx3(kk, jj, k, j+1, i-1)]);
                wcw[idx3(kk, jj, k, j+1, i)] = qkww;
            }
            ...
            dzk = dz[idx1(k)];
            awx = ddyj*dzk;
            fww = awx*(ut[idx3(kk, jj, k-1, j, i-1)] + ut[idx3(kk, jj, k-1, j+1, i-1)] + ut[idx3(kk, jj, k, j, i-1)] + ut[idx3(kk, jj, k, j+1, i-1)] + 2*ut[idx3(kk, jj, k+1, j, i-1)] + 2*ut[idx3(kk, jj, k+1, j+1, i-1)])*0.125;
            qkww = 0.5*fww*(w[idx3(kk, jj, k, j, i)] + w[idx3(kk, jj, k, j, i-1)]);
            wcw[idx3(kk, jj, k, j, i)] = qkww;
            qkww = 0.5*fww*(w[idx3(kk, jj, k, j+1, i)] + w[idx3(kk, jj, k, j+1, i-1)]);
            wcw[idx3(kk, jj, k, j+1, i)] = qkww;
...
#pragma omp for
        ...
        for (intk_c j = 2; j <= jj-2; ++j) {
            ...
            for (intk_c k = 3; k <= kk-2; ++k) {
                ...
                realk_c avx = ddzk*dyj;
                realk_c fvw = avx *(ut[idx3(kk, jj, k, j, i-1)] + ut[idx3(kk, jj, k, j+1, i-1)])*0.5;
                realk_c qkvw = 0.5*fvw*(v[idx3(kk, jj, k, j, i)] + v[idx3(kk, jj, k, j, i-1)]);
...
#pragma omp for
        ...
        for (intk_c k = 3; k <= kk-2; k += 2) {
            realk_c ddzk = ddz[idx1(k)];
            realk_c avx = ddzk*dyj;
            realk_c fvw = avx*(2*ut[idx3(kk, jj, k, j, i-1)] + 2*ut[idx3(kk, jj, k+1, j, i-1)] + ut[idx3(kk, jj, k, j+1, i-1)] + ut[idx3(kk, jj, k+1, j+1, i-1)] + ut[idx3(kk, jj, k, j+2, i-1)] + ut[idx3(kk, jj, k+1, j+2, i-1)])*0.125;
            realk_c qkvw = 0.5*fvw*(v[idx3(kk, jj, k, j, i)] + v[idx3(kk, jj, k, j, i-1)]);
            wcv[idx3(kk, jj, k, j, i)] = qkvw;
            qkvw = 0.5*fvw*(v[idx3(kk, jj, k+1, j, i)] + v[idx3(kk, jj, k+1, j, i-1)]);
...
#pragma omp for
        ...
        for (intk_c j = 4; j <= jj-4; j += 2) {
            ...
            for (intk_c k = 3; k <= kk-2; k += 2) {
                realk_c ddzk = ddz[idx1(k)];
                realk_c avx = ddzk*dyj;
                realk_c fvw = avx*(ut[idx3(kk, jj, k, j-1, i-1)] + ut[idx3(kk, jj, k+1, j-1, i-1)] + ut[idx3(kk, jj, k, j, i-1)] + ut[idx3(kk, jj, k+1, j, i-1)] + ut[idx3(kk, jj, k, j+1, i-1)] + ut[idx3(kk, jj, k+1, j+1, i-1)] + ut[idx3(kk, jj, k, j+2, i-1)] + ut[idx3(kk, jj, k+1, j+2, i-1)])*0.125;
                realk_c qkvw = 0.5*fvw*(v[idx3(kk, jj, k, j, i)] + v[idx3(kk, jj, k, j, i-1)]);
                wcv[idx3(kk, jj, k, j, i)] = qkvw;
                qkvw = 0.5*fvw*(v[idx3(kk, jj, k+1, j, i)] + v[idx3(kk, jj, k+1, j, i-1)]);
                wcv[idx3(kk, jj, k+1, j, i)] = qkvw;
...
#pragma omp for
        ...
        for (intk_c k = 3; k <= kk-2; k += 2) {
            realk_c ddzk = ddz[idx1(k)];
            realk_c avx = ddzk*dyj;
            realk_c fvw = avx*(ut[idx3(kk, jj, k, j-1, i-1)] + ut[idx3(kk, jj, k+1, j-1, i-1)] + ut[idx3(kk, jj, k, j, i-1)] + ut[idx3(kk, jj, k+1, j, i-1)] + 2*ut[idx3(kk, jj, k, j+1, i-1)] + 2*ut[idx3(kk, jj, k+1, j+1, i-1)])*0.125;
            realk_c qkvw = 0.5*fvw*(v[idx3(kk, jj, k, j, i)] + v[idx3(kk, jj, k, j, i-1)]);
            wcv[idx3(kk, jj, k, j, i)] = qkvw;
            qkvw = 0.5*fvw*(v[idx3(kk, jj, k+1, j, i)] + v[idx3(kk, jj, k+1, j, i-1)]);
            wcv[idx3(kk, jj, k+1, j, i)] = qkvw;
...
#pragma omp for
        ...
        for (intk_c i = 2; i <= ii-2; ++i) {
            ...
            for (intk_c j = 3; j <= jj-2; ++j) {
                realk_c ddyj = ddy[idx1(j)];
                realk_c auz = dxi*ddyj;
                realk_c fut = auz*(wt[idx3(kk, jj, k, j, i)] + wt[idx3(kk, jj, k, j, i+1)])*0.5;
                realk_c qkut = 0.5*fut*(u[idx3(kk, jj, k, j, i)] + u[idx3(kk, jj, k+1, j, i)]);
...
#pragma omp for
        ...
        for (intk_c j = 3; j <= jj-2; j += 2) {
            realk_c ddyj = ddy[idx1(j)];
            realk_c auz = dxi*ddyj;
            realk_c fut = auz*(2*wt[idx3(kk, jj, k, j, i)] + 2*wt[idx3(kk, jj, k, j+1, i)] + wt[idx3(kk, jj, k, j, i+1)] + wt[idx3(kk, jj, k, j+1, i+1)] + wt[idx3(kk, jj, k, j, i+2)] + wt[idx3(kk, jj, k, j+1, i+2)])*0.125;
            realk_c qkut = 0.5*fut*(u[idx3(kk, jj, k, j, i)] + u[idx3(kk, jj, k+1, j, i)]);
            wcu[idx3(kk, jj, k, j, i)] = qkut;
            qkut = 0.5*fut*(u[idx3(kk, jj, k, j+1, i)] + u[idx3(kk, jj, k+1, j+1, i)]);
...
#pragma omp for
        ...
        for (intk_c i = 4; i <= ii-4; i += 2) {
            ...
            for (intk_c j = 3; j <= jj-2; j += 2) {
                realk_c ddyj = ddy[idx1(j)];
                realk_c auz = dxi*ddyj;
                realk_c fut = auz*(wt[idx3(kk, jj, k, j, i-1)] + wt[idx3(kk, jj, k, j+1, i-1)] + wt[idx3(kk, jj, k, j, i)] + wt[idx3(kk, jj, k, j+1, i)] + wt[idx3(kk, jj, k, j, i+1)] + wt[idx3(kk, jj, k, j+1, i+1)] + wt[idx3(kk, jj, k, j, i+2)] + wt[idx3(kk, jj, k, j+1, i+2)])*0.125;
                realk_c qkut = 0.5*fut*(u[idx3(kk, jj, k, j, i)] + u[idx3(kk, jj, k+1, j, i)]);
                wcu[idx3(kk, jj, k, j, i)] = qkut;
                qkut = 0.5*fut*(u[idx3(kk, jj, k, j+1, i)] + u[idx3(kk, jj, k+1, j+1, i)]);
                wcu[idx3(kk, jj, k, j+1, i)] = qkut;
...
#pragma omp for
        ...
        for (intk_c j = 3; j <= jj-2; j += 2) {
            realk_c ddyj = ddy[idx1(j)];
            realk_c auz = dxi*ddyj;
            realk_c fut = auz*(wt[idx3(kk, jj, k, j, i-1)] + wt[idx3(kk, jj, k, j+1, i-1)] + wt[idx3(kk, jj, k, j, i)] + wt[idx3(kk, jj, k, j+1, i)] + 2*wt[idx3(kk, jj, k, j, i+1)] + 2*wt[idx3(kk, jj, k, j+1, i+1)])*0.125;
            realk_c qkut = 0.5*fut*(u[idx3(kk, jj, k, j, i)] + u[idx3(kk, jj, k+1, j, i)]);
            wcu[idx3(kk, jj, k, j, i)] = qkut;
            qkut = 0.5*fut*(u[idx3(kk, jj, k, j+1, i)] + u[idx3(kk, jj, k+1, j+1, i)]);
            wcu[idx3(kk, jj, k, j+1, i)] = qkut;
...
#pragma omp for collapse(1)
        ...
        for (intk_c i = 2; i <= ii-4; i += 2) {
            for (intk_c j = 3; j <= jj-2; ++j) {
                wcu[idx3(kk, jj, k, j, i+1)] = 0.5*(wcu[idx3(kk, jj, k, j, i)] + wcu[idx3(kk, jj, k, j, i+2)]);
            }
        }
#if defined(_OPENMP)
#pragma omp barrier
...
#pragma omp for collapse(2)
        ...
        for (intk_c i = 2; i <= ii-2; ++i) {
            for (intk_c j = 3; j <= jj-2; ++j) {
                realk_c fkdtu = -1.0*rddy[idx1(j)]*rdx[idx1(i)]*wkon;
                uo[idx3(kk, jj, k, j, i)] = uo[idx3(kk, jj, k, j, i)] + fkdtu*rddzk*(wcu[idx3(kk, jj, k, j, i)] - wcu[idx3(kk, jj, k+1, j, i)]);
            }
        }
#if defined(_OPENMP)
#pragma omp barrier
...
#pragma omp for
        ...
        for (intk_c i = 3; i <= ii-2; ++i) {
            ...
            for (intk_c j = 2; j <= jj-2; ++j) {
                realk_c dyj = dy[idx1(j)];
                realk_c avz = ddxi*dyj;
                realk_c fvt = avz*(wt[idx3(kk, jj, k, j, i)] + wt[idx3(kk, jj, k, j+1, i)])*0.5;
                realk_c qkvt = 0.5*fvt*(v[idx3(kk, jj, k, j, i)] + v[idx3(kk, jj, k+1, j, i)]);
...
#pragma omp for
        ...
        for (intk_c i = 3; i <= ii-2; i += 2) {
            ...
            realk_c dyj = dy[idx1(j)];
            realk_c avz = ddxi*dyj;
            realk_c fvt = avz*(2*wt[idx3(kk, jj, k, j, i)] + 2*wt[idx3(kk, jj, k, j, i+1)] + wt[idx3(kk, jj, k, j+1, i)] + wt[idx3(kk, jj, k, j+1, i+1)] + wt[idx3(kk, jj, k, j+2, i)] + wt[idx3(kk, jj, k, j+2, i+1)])*0.125;
            realk_c qkvt = 0.5*fvt*(v[idx3(kk, jj, k, j, i)] + v[idx3(kk, jj, k+1, j, i)]);
            wcv[idx3(kk, jj, k, j, i)] = qkvt;
            qkvt = 0.5*fvt*(v[idx3(kk, jj, k, j, i+1)] + v[idx3(kk, jj, k+1, j, i+1)]);
            wcv[idx3(kk, jj, k, j, i+1)] = qkvt;
            for (intk_c j = 4; j <= jj-4; j += 2) {
                dyj = dy[idx1(j)];
                avz = ddxi*dyj;
                fvt = avz*(wt[idx3(kk, jj, k, j-1, i)] + wt[idx3(kk, jj, k, j-1, i+1)] + wt[idx3(kk, jj, k, j, i)] + wt[idx3(kk, jj, k, j, i+1)] + wt[idx3(kk, jj, k, j+1, i)] + wt[idx3(kk, jj, k, j+1, i+1)] + wt[idx3(kk, jj, k, j+2, i)] + wt[idx3(kk, jj, k, j+2, i+1)])*0.125;
                qkvt = 0.5*fvt*(v[idx3(kk, jj, k, j, i)] + v[idx3(kk, jj, k+1, j, i)]);
                wcv[idx3(kk, jj, k, j, i)] = qkvt;
                qkvt = 0.5*fvt*(v[idx3(kk, jj, k, j, i+1)] + v[idx3(kk, jj, k+1, j, i+1)]);
                wcv[idx3(kk, jj, k, j, i+1)] = qkvt;
            }
            ...
            dyj = dy[idx1(j)];
            avz = ddxi*dyj;
            fvt = avz*(wt[idx3(kk, jj, k, j-1, i)] + wt[idx3(kk, jj, k, j-1, i+1)] + wt[idx3(kk, jj, k, j, i)] + wt[idx3(kk, jj, k, j, i+1)] + 2*wt[idx3(kk, jj, k, j+1, i)] + 2*wt[idx3(kk, jj, k, j+1, i+1)])*0.125;
            qkvt = 0.5*fvt*(v[idx3(kk, jj, k, j, i)] + v[idx3(kk, jj, k+1, j, i)]);
            wcv[idx3(kk, jj, k, j, i)] = qkvt;
            qkvt = 0.5*fvt*(v[idx3(kk, jj, k, j, i+1)] + v[idx3(kk, jj, k+1, j, i+1)]);
            wcv[idx3(kk, jj, k, j, i+1)] = qkvt;
...
#pragma omp for collapse(2)
        ...
        for (intk_c i = 3; i <= ii-2; ++i) {
            for (intk_c j = 2; j <= jj-2; ++j) {
                realk_c fkdtv = -1.0*rddx[idx1(i)]*rdy[idx1(j)]*wkon;
                vo[idx3(kk, jj, k, j, i)] = vo[idx3(kk, jj, k, j, i)] + fkdtv*rddzk*(wcv[idx3(kk, jj, k, j, i)] - wcv[idx3(kk, jj, k+1, j, i)]);
            }
        }
#if defined(_OPENMP)
#pragma omp barrier
...
#pragma omp for
        ...
        for (intk_c i = 2; i <= ii-2; ++i) {
            ...
            for (intk_c j = 3; j <= jj-2; ++j) {
                ...
                realk_c auz = dxi*ddyj;
                realk_c fub = auz*(wt[idx3(kk, jj, k-1, j, i)] + wt[idx3(kk, jj, k-1, j, i+1)])*0.5;
                realk_c qkub = 0.5*fub*(u[idx3(kk, jj, k, j, i)] + u[idx3(kk, jj, k-1, j, i)]);
...
#pragma omp for
        ...
        for (intk_c j = 3; j <= jj-2; j += 2) {
            realk_c ddyj = ddy[idx1(j)];
            realk_c auz = dxi*ddyj;
            realk_c fub = auz*(2*wt[idx3(kk, jj, k-1, j, i)] + 2*wt[idx3(kk, jj, k-1, j+1, i)] + wt[idx3(kk, jj, k-1, j, i+1)] + wt[idx3(kk, jj, k-1, j+1, i+1)] + wt[idx3(kk, jj, k-1, j, i+2)] + wt[idx3(kk, jj, k-1, j+1, i+2)])*0.125;
            realk_c qkub = 0.5*fub*(u[idx3(kk, jj, k, j, i)] + u[idx3(kk, jj, k-1, j, i)]);
            wcu[idx3(kk, jj, k, j, i)] = qkub;
            qkub = 0.5*fub*(u[idx3(kk, jj, k, j+1, i)] + u[idx3(kk, jj, k-1, j+1, i)]);
...
#pragma omp for
        ...
        for (intk_c i = 4; i <= ii-4; i += 2) {
            ...
            for (intk_c j = 3; j <= jj-2; j += 2) {
                realk_c ddyj = ddy[idx1(j)];
                realk_c auz = dxi*ddyj;
                realk_c fub = auz*(wt[idx3(kk, jj, k-1, j, i-1)] + wt[idx3(kk, jj, k-1, j+1, i-1)] + wt[idx3(kk, jj, k-1, j, i)] + wt[idx3(kk, jj, k-1, j+1, i)] + wt[idx3(kk, jj, k-1, j, i+1)] + wt[idx3(kk, jj, k-1, j+1, i+1)] + wt[idx3(kk, jj, k-1, j, i+2)] + wt[idx3(kk, jj, k-1, j+1, i+2)])*0.125;
                realk_c qkub = 0.5*fub*(u[idx3(kk, jj, k, j, i)] + u[idx3(kk, jj, k-1, j, i)]);
                wcu[idx3(kk, jj, k, j, i)] = qkub;
                qkub = 0.5*fub*(u[idx3(kk, jj, k, j+1, i)] + u[idx3(kk, jj, k-1, j+1, i)]);
                wcu[idx3(kk, jj, k, j+1, i)] = qkub;
...
#pragma omp for
        ...
        for (intk_c j = 3; j <= jj-2; j += 2) {
            realk_c ddyj = ddy[idx1(j)];
            realk_c auz = dxi*ddyj;
            realk_c fub = auz*(wt[idx3(kk, jj, k-1, j, i-1)] + wt[idx3(kk, jj, k-1, j+1, i-1)] + wt[idx3(kk, jj, k-1, j, i)] + wt[idx3(kk, jj, k-1, j+1, i)] + 2*wt[idx3(kk, jj, k-1, j, i+1)] + 2*wt[idx3(kk, jj, k-1, j+1, i+1)])*0.125;
            realk_c qkub = 0.5*fub*(u[idx3(kk, jj, k, j, i)] + u[idx3(kk, jj, k-1, j, i)]);
            wcu[idx3(kk, jj, k, j, i)] = qkub;
            qkub = 0.5*fub*(u[idx3(kk, jj, k, j+1, i)] + u[idx3(kk, jj, k-1, j+1, i)]);
            wcu[idx3(kk, jj, k, j+1, i)] = qkub;
...
#pragma omp for
        ...
        for (intk_c i = 3; i <= ii-2; ++i) {
            ...
            for (intk_c j = 2; j <= jj-2; ++j) {
                ...
                realk_c avz = ddxi*dyj;
                realk_c fvb = avz*(wt[idx3(kk, jj, k-1, j, i)] + wt[idx3(kk, jj, k-1, j+1, i)])*0.5;
                realk_c qkvb = 0.5*fvb*(v[idx3(kk, jj, k, j, i)] + v[idx3(kk, jj, k-1, j, i)]);
...
#pragma omp for
        ...
        for (intk_c i = 3; i <= ii-2; i += 2) {
            ...
            realk_c dyj = dy[idx1(j)];
            realk_c avz = ddxi* dyj;
            realk_c fvb = avz*(2*wt[idx3(kk, jj, k-1, j, i)] + 2*wt[idx3(kk, jj, k-1, j, i+1)] + wt[idx3(kk, jj, k-1, j+1, i)] + wt[idx3(kk, jj, k-1, j+1, i+1)] + wt[idx3(kk, jj, k-1, j+2, i)] + wt[idx3(kk, jj, k-1, j+2, i+1)])*0.125;
            realk_c qkvb = 0.5*fvb*(v[idx3(kk, jj, k, j, i)] + v[idx3(kk, jj, k-1, j, i)]);
            wcv[idx3(kk, jj, k, j, i)] = qkvb;
            qkvb = 0.5*fvb*(v[idx3(kk, jj, k, j, i+1)] + v[idx3(kk, jj, k-1, j, i+1)]);
            wcv[idx3(kk, jj, k, j, i+1)] = qkvb;
            for (intk_c j = 4; j <= jj-4; j += 2) {
                dyj = dy[idx1(j)];
                avz = ddxi* dyj;
                fvb = avz*(wt[idx3(kk, jj, k-1, j-1, i)] + wt[idx3(kk, jj, k-1, j-1, i+1)] + wt[idx3(kk, jj, k-1, j, i)] + wt[idx3(kk, jj, k-1, j, i+1)] + wt[idx3(kk, jj, k-1, j+1, i)] + wt[idx3(kk, jj, k-1, j+1, i+1)] + wt[idx3(kk, jj, k-1, j+2, i)] + wt[idx3(kk, jj, k-1, j+2, i+1)])*0.125;
                qkvb = 0.5*fvb*(v[idx3(kk, jj, k, j, i)] + v[idx3(kk, jj, k-1, j, i)]);
                wcv[idx3(kk, jj, k, j, i)] = qkvb;
                qkvb = 0.5*fvb*(v[idx3(kk, jj, k, j, i+1)] + v[idx3(kk, jj, k-1, j, i+1)]);
                wcv[idx3(kk, jj, k, j, i+1)] = qkvb;
            }
            ...
            dyj = dy[idx1(j)];
            avz = ddxi* dyj;
            fvb = avz*(wt[idx3(kk, jj, k-1, j-1, i)] + wt[idx3(kk, jj, k-1, j-1, i+1)] + wt[idx3(kk, jj, k-1, j, i)] + wt[idx3(kk, jj, k-1, j, i+1)] + 2*wt[idx3(kk, jj, k-1, j+1, i)] + 2*wt[idx3(kk, jj, k-1, j+1, i+1)])*0.125;
            qkvb = 0.5*fvb*(v[idx3(kk, jj, k, j, i)] + v[idx3(kk, jj, k-1, j, i)]);
            wcv[idx3(kk, jj, k, j, i)] = qkvb;
            qkvb = 0.5*fvb*(v[idx3(kk, jj, k, j, i+1)] + v[idx3(kk, jj, k-1, j, i+1)]);
            wcv[idx3(kk, jj, k, j, i+1)] = qkvb;
...
#pragma omp for
        ...
        for (intk_c i = 2; i <= ii-2; ++i) {
            ...
            for (intk_c k = 3; k <= kk-2; ++k) {
                realk_c ddzk = ddz[idx1(k)];
                realk_c auy = dxi*ddzk;
                realk_c fun = auy*(vt[idx3(kk, jj, k, j, i)] + vt[idx3(kk, jj, k, j, i+1)])*0.5;
                realk_c qkun = 0.5*fun*(u[idx3(kk, jj, k, j, i)] + u[idx3(kk, jj, k, j+1, i)]);
...
#pragma omp for
        ...
        for (intk_c k = 3; k <= kk-2; k += 2) {
            realk_c ddzk = ddz[idx1(k)];
            realk_c auy = dxi*ddzk;
            realk_c fun = auy*(2*vt[idx3(kk, jj, k, j, i)] + 2*vt[idx3(kk, jj, k+1, j, i)] + vt[idx3(kk, jj, k, j, i+1)] + vt[idx3(kk, jj, k+1, j, i+1)] + vt[idx3(kk, jj, k, j, i+2)] + vt[idx3(kk, jj, k+1, j, i+2)])*0.125;
            realk_c qkun = 0.5*fun*(u[idx3(kk, jj, k, j, i)] + u[idx3(kk, jj, k, j+1, i)]);
            wcu[idx3(kk, jj, k, j, i)] = qkun;
            qkun = 0.5*fun*(u[idx3(kk, jj, k+1, j, i)] + u[idx3(kk, jj, k+1, j+1, i)]);
...
#pragma omp for
        ...
        for (intk_c i = 4; i <= ii-4; i += 2) {
            ...
            for (intk_c k = 3; k <= kk-2; k += 2) {
                realk_c ddzk = ddz[idx1(k)];
                realk_c auy = dxi*ddzk;
                realk_c fun = auy*(vt[idx3(kk, jj, k, j, i-1)] + vt[idx3(kk, jj, k+1, j, i-1)] + vt[idx3(kk, jj, k, j, i)] + vt[idx3(kk, jj, k+1, j, i)] + vt[idx3(kk, jj, k, j, i+1)] + vt[idx3(kk, jj, k+1, j, i+1)] + vt[idx3(kk, jj, k, j, i+2)] + vt[idx3(kk, jj, k+1, j, i+2)])*0.125;
                realk_c qkun = 0.5*fun*(u[idx3(kk, jj, k, j, i)] + u[idx3(kk, jj, k, j+1, i)]);
                wcu[idx3(kk, jj, k, j, i)] = qkun;
                qkun = 0.5*fun*(u[idx3(kk, jj, k+1, j, i)] + u[idx3(kk, jj, k+1, j+1, i)]);
                wcu[idx3(kk, jj, k+1, j, i)] = qkun;
...
#pragma omp for
        ...
        for (intk_c k = 3; k <= kk-2; k += 2) {
            realk_c ddzk = ddz[idx1(k)];
            realk_c auy = dxi*ddzk;
            realk_c fun = auy*(vt[idx3(kk, jj, k, j, i-1)] + vt[idx3(kk, jj, k+1, j, i-1)] + vt[idx3(kk, jj, k, j, i)] + vt[idx3(kk, jj, k+1, j, i)] + 2*vt[idx3(kk, jj, k, j, i+1)] + 2*vt[idx3(kk, jj, k+1, j, i+1)])*0.125;
            realk_c qkun = 0.5*fun*(u[idx3(kk, jj, k, j, i)] + u[idx3(kk, jj, k, j+1, i)]);
            wcu[idx3(kk, jj, k, j, i)] = qkun;
            qkun = 0.5*fun*(u[idx3(kk, jj, k+1, j, i)] + u[idx3(kk, jj, k+1, j+1, i)]);
            wcu[idx3(kk, jj, k+1, j, i)] = qkun;
...
#pragma omp for
        ...
        for (intk_c i = 2; i <= ii-2; ++i) {
            ...
            for (intk_c k = 3; k <= kk-2; ++k) {
                realk_c rddzk = rddz[idx1(k)];
                uo[idx3(kk, jj, k, j, i)] = uo[idx3(kk, jj, k, j, i)] + fkdtu*rddzk*(wcu[idx3(kk, jj, k, j, i)] - wcu[idx3(kk, jj, k, j+1, i)]);
            }
        }
#if defined(_OPENMP)
#pragma omp barrier
...
#pragma omp for
        ...
        for (intk_c i = 3; i <= ii-2; ++i) {
            ...
            for (intk_c k = 2; k <= kk-2; ++k) {
                realk_c dzk = dz[idx1(k)];
                realk_c awy = ddxi*dzk;
                realk_c fwn = awy*(vt[idx3(kk, jj, k, j, i)] + vt[idx3(kk, jj, k+1, j, i)])*0.5;
                realk_c qkwn = 0.5*fwn*(w[idx3(kk, jj, k, j, i)] + w[idx3(kk, jj, k, j+1, i)]);
...
#pragma omp for
        ...
        for (intk_c i = 3; i <= ii-2; i += 2) {
            ...
            realk_c dzk = dz[idx1(k)];
            realk_c awy = ddxi*dzk;
            realk_c fwn = awy*(2*vt[idx3(kk, jj, k, j, i)] + 2*vt[idx3(kk, jj, k, j, i+1)] + vt[idx3(kk, jj, k+1, j, i)] + vt[idx3(kk, jj, k+1, j, i+1)] + vt[idx3(kk, jj, k+2, j, i)] + vt[idx3(kk, jj, k+2, j, i+1)])*0.125;
            realk_c qkwn = 0.5*fwn*(w[idx3(kk, jj, k, j, i)] + w[idx3(kk, jj, k, j+1, i)]);
            wcw[idx3(kk, jj, k, j, i)] = qkwn;
            qkwn = 0.5*fwn*(w[idx3(kk, jj, k, j, i+1)] + w[idx3(kk, jj, k, j+1, i+1)]);
            wcw[idx3(kk, jj, k, j, i+1)] = qkwn;
            for (intk_c k = 4; k <= kk-4; ++k) {
                dzk = dz[idx1(k)];
                awy = ddxi*dzk;
                fwn = awy*(vt[idx3(kk, jj, k-1, j, i)] + vt[idx3(kk, jj, k-1, j, i+1)] + vt[idx3(kk, jj, k, j, i)] + vt[idx3(kk, jj, k, j, i+1)] + vt[idx3(kk, jj, k+1, j, i)] + vt[idx3(kk, jj, k+1, j, i+1)] + vt[idx3(kk, jj, k+2, j, i)] + vt[idx3(kk, jj, k+2, j, i+1)])*0.125;
                qkwn = 0.5*fwn*(w[idx3(kk, jj, k, j, i)] + w[idx3(kk, jj, k, j+1, i)]);
                wcw[idx3(kk, jj, k, j, i)] = qkwn;
                qkwn = 0.5*fwn*(w[idx3(kk, jj, k, j, i+1)] + w[idx3(kk, jj, k, j+1, i+1)]);
                wcw[idx3(kk, jj, k, j, i+1)] = qkwn;
            }
            ...
            dzk = dz[idx1(k)];
            awy = ddxi*dzk;
            fwn = awy*(vt[idx3(kk, jj, k-1, j, i)] + vt[idx3(kk, jj, k-1, j, i+1)] + vt[idx3(kk, jj, k, j, i)] + vt[idx3(kk, jj, k, j, i+1)] + 2*vt[idx3(kk, jj, k+1, j, i)] + 2*vt[idx3(kk, jj, k+1, j, i+1)])*0.125;
            qkwn = 0.5*fwn*(w[idx3(kk, jj, k, j, i)] + w[idx3(kk, jj, k, j+1, i)]);
            wcw[idx3(kk, jj, k, j, i)] = qkwn;
            qkwn = 0.5*fwn*(w[idx3(kk, jj, k, j, i+1)] + w[idx3(kk, jj, k, j+1, i+1)]);
            wcw[idx3(kk, jj, k, j, i+1)] = qkwn;
...
#pragma omp for
        ...
        for (intk_c i = 3; i <= ii-2; ++i) {
            ...
            for (intk_c k = 2; k <= kk-2; ++k) {
                realk_c rdzk = rdz[idx1(k)];
                wo[idx3(kk, jj, k, j, i)] = wo[idx3(kk, jj, k, j, i)] + fkdtw*rdzk*(-wcw[idx3(kk, jj, k, j+1, i)] + wcw[idx3(kk, jj, k, j, i)]);
            }
        }
#if defined(_OPENMP)
#pragma omp barrier
...
#pragma omp for
        ...
        for (intk_c i = 2; i <= ii-2; ++i) {
            ...
            for (intk_c k = 3; k <= kk-2; ++k) {
                ...
                realk_c auy = dxi*ddzk;
                realk_c fus = auy*(vt[idx3(kk, jj, k, j-1, i)] + vt[idx3(kk, jj, k, j-1, i+1)])*0.5;
                realk_c qkus = 0.5*fus*(u[idx3(kk, jj, k, j, i)] + u[idx3(kk, jj, k, j-1, i)]);
...
#pragma omp for
        ...
        for (intk_c k = 3; k <= kk-2; k += 2) {
            realk_c ddzk = ddz[idx1(k)];
            realk_c auy = dxi*ddzk;
            realk_c fus = auy*(2*vt[idx3(kk, jj, k, j-1, i)] + 2*vt[idx3(kk, jj, k+1, j-1, i)] + vt[idx3(kk, jj, k, j-1, i+1)] + vt[idx3(kk, jj, k+1, j-1, i+1)] + vt[idx3(kk, jj, k, j-1, i+2)] + vt[idx3(kk, jj, k+1, j-1, i+2)])*0.125;
            realk_c qkus = 0.5*fus*(u[idx3(kk, jj, k, j, i)] + u[idx3(kk, jj, k, j-1, i)]);
            wcu[idx3(kk, jj, k, j, i)] = qkus;
            qkus = 0.5*fus*(u[idx3(kk, jj, k+1, j, i)] + u[idx3(kk, jj, k+1, j-1, i)]);
...
#pragma omp for
        ...
        for (intk_c i = 4; i <= ii-4; i += 2) {
            ...
            for (intk_c k = 3; k <= kk-2; k += 2) {
                realk_c ddzk = ddz[idx1(k)];
                realk_c auy = dxi*ddzk;
                realk_c fus = auy*(vt[idx3(kk, jj, k, j-1, i-1)] + vt[idx3(kk, jj, k+1, j-1, i-1)] + vt[idx3(kk, jj, k, j-1, i)] + vt[idx3(kk, jj, k+1, j-1, i)] + vt[idx3(kk, jj, k, j-1, i+1)] + vt[idx3(kk, jj, k+1, j-1, i+1)] + vt[idx3(kk, jj, k, j-1, i+2)] + vt[idx3(kk, jj, k+1, j-1, i+2)])*0.125;
                realk_c qkus = 0.5*fus*(u[idx3(kk, jj, k, j, i)] + u[idx3(kk, jj, k, j-1, i)]);
                wcu[idx3(kk, jj, k, j, i)] = qkus;
                qkus = 0.5*fus*(u[idx3(kk, jj, k+1, j, i)] + u[idx3(kk, jj, k+1, j-1, i)]);
                wcu[idx3(kk, jj, k+1, j, i)] = qkus;
...
#pragma omp for
        ...
        for (intk_c k = 3; k <= kk-2; k += 2) {
            realk_c ddzk = ddz[idx1(k)];
            realk_c auy = dxi*ddzk;
            realk_c fus = auy*(vt[idx3(kk, jj, k, j-1, i-1)] + vt[idx3(kk, jj, k+1, j-1, i-1)] + vt[idx3(kk, jj, k, j-1, i)] + vt[idx3(kk, jj, k+1, j-1, i)] +2 *vt[idx3(kk, jj, k, j-1, i+1)] + 2*vt[idx3(kk, jj, k+1, j-1, i+1)])*0.125;
            realk_c qkus = 0.5*fus*(u[idx3(kk, jj, k, j, i)] + u[idx3(kk, jj, k, j-1, i)]);
            wcu[idx3(kk, jj, k, j, i)] = qkus;
            qkus = 0.5*fus*(u[idx3(kk, jj, k+1, j, i)] + u[idx3(kk, jj, k+1, j-1, i)]);
            wcu[idx3(kk, jj, k+1, j, i)] = qkus;
...
#pragma omp for
        ...
        for (intk_c i = 3; i <= ii-2; ++i) {
            ...
            for (intk_c k = 2; k <= kk-2; ++k) {
                ...
                realk_c awy = ddxi*dzk;
                realk_c fws = awy*(vt[idx3(kk, jj, k, j-1, i)] + vt[idx3(kk, jj, k+1, j-1, i)])*0.5;
                realk_c qkws = 0.5*fws*(w[idx3(kk, jj, k, j, i)] + w[idx3(kk, jj, k, j-1, i)]);
...
#pragma omp for
        ...
        for (intk_c i = 3; i <= ii-2; i += 2) {
            ...
            realk_c dzk = dz[idx1(k)];
            realk_c awy = ddxi*dzk;
            realk_c fws = awy*(2*vt[idx3(kk, jj, k, j-1, i)] + 2*vt[idx3(kk, jj, k, j-1, i+1)] + vt[idx3(kk, jj, k+1, j-1, i)] + vt[idx3(kk, jj, k+1, j-1, i+1)] + vt[idx3(kk, jj, k+2, j-1, i)] + vt[idx3(kk, jj, k+2, j-1, i+1)])*0.125;
            realk_c qkws = 0.5*fws*(w[idx3(kk, jj, k, j, i)] + w[idx3(kk, jj, k, j-1, i)]);
            wcw[idx3(kk, jj, k, j, i)] = qkws;
            qkws = 0.5*fws*(w[idx3(kk, jj, k, j, i+1)] + w[idx3(kk, jj, k, j-1, i+1)]);
            wcw[idx3(kk, jj, k, j, i+1)] = qkws;
            for (intk_c k = 4; k <= kk-4; ++k) {
                dzk = dz[idx1(k)];
                awy = ddxi*dzk;
                fws = awy*(vt[idx3(kk, jj, k-1, j-1, i)] + vt[idx3(kk, jj, k-1, j-1, i+1)] + vt[idx3(kk, jj, k, j-1, i)] + vt[idx3(kk, jj, k, j-1, i+1)] + vt[idx3(kk, jj, k+1, j-1, i)] + vt[idx3(kk, jj, k+1, j-1, i+1)] + vt[idx3(kk, jj, k+2, j-1, i)] + vt[idx3(kk, jj, k+2, j-1, i+1)])*0.125;
                qkws = 0.5*fws*(w[idx3(kk, jj, k, j, i)] + w[idx3(kk, jj, k, j-1, i)]);
                wcw[idx3(kk, jj, k, j, i)] = qkws;
                qkws = 0.5*fws*(w[idx3(kk, jj, k, j, i+1)] + w[idx3(kk, jj, k, j-1, i+1)]);
                wcw[idx3(kk, jj, k, j, i+1)] = qkws;
            }
            ...
            dzk = dz[idx1(k)];
            awy = ddxi*dzk;
            fws = awy*(vt[idx3(kk, jj, k-1, j-1, i)] + vt[idx3(kk, jj, k-1, j-1, i+1)] + vt[idx3(kk, jj, k, j-1, i)] + vt[idx3(kk, jj, k, j-1, i+1)] + 2*vt[idx3(kk, jj, k+1, j-1, i)] + 2*vt[idx3(kk, jj, k+1, j-1, i+1)])*0.125;
            qkws = 0.5*fws*(w[idx3(kk, jj, k, j, i)] + w[idx3(kk, jj, k, j-1, i)]);
            wcw[idx3(kk, jj, k, j, i)] = qkws;
            qkws = 0.5*fws*(w[idx3(kk, jj, k, j, i+1)] + w[idx3(kk, jj, k, j-1, i+1)]);
            wcw[idx3(kk, jj, k, j, i+1)] = qkws;
