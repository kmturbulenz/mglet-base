...
CONTAINS
    SUBROUTINE init_scalar()
        ...
        CALL set_timer(429, "SCA_DETAIL_SCALAR ==========")
        CALL set_timer(430, "SCA_DETAIL_COPY_TOLD")
        CALL set_timer(435, "SCA_DETAIL_TSTSCA4")
        CALL set_timer(440, "SCA_DETAIL_PARENT")
        CALL set_timer(445, "SCA_DETAIL_BOUND")
        CALL set_timer(450, "SCA_DETAIL_FLUXBALANCE")
        CALL set_timer(455, "SCA_DETAIL_SOURCETERM")
        CALL set_timer(460, "SCA_DETAIL_STENCILS_QTT")
        CALL set_timer(465, "SCA_DETAIL_RKSTEP")
        CALL set_timer(470, "SCA_DETAIL_MASKBT")
        CALL set_timer(475, "SCA_DETAIL_CONNECT")
        CALL set_timer(480, "SCA_DETAIL_STENCILS")
        CALL set_timer(485, "SCA_DETAIL_FTOC")
        CALL set_timer(490, "SCA_DETAIL_CONNECT")
